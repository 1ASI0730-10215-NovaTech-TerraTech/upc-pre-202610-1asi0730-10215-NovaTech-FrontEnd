...
### 2. Start the Data Server (Mock API)
The application uses `json-server` to simulate an API. It is **essential** that this command is running in order to display lots and recommendations:
